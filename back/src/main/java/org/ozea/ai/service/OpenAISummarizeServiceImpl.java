...
@Log4j2
@Service
public class OpenAISummarizeServiceImpl implements OpenAISummarizeService {
    ...
    public OpenAISummarizeServiceImpl(
    ...
    public String formatToThreeBullets (String content){
    ...
    public String limitLength(String s, int max) {
