...
public class PointController {
    ...
    @ApiOperation(value = "포인트 내역 조회", notes = "사용자의 포인트 적립/출금 내역을 조회합니다.")
    ...
    @ApiOperation(value = "포인트 내역 조회 (타입별)", notes = "사용자의 포인트 내역을 타입별로 조회합니다.")
    ...
    @ApiOperation(value = "총 포인트 조회", notes = "사용자의 총 보유 포인트를 조회합니다.")
    ...
    @ApiOperation(value = "포인트 적립", notes = "사용자에게 포인트를 적립합니다.")
    ...
    @ApiOperation(value = "포인트 출금", notes = "현재 로그인한 사용자의 포인트를 출금합니다.")
