...
.card {
  width: clamp(
    240px,
    calc(240px + (360 - 240) * ((100vw - 1024px) / (1920 - 1024))),
    360px
  );
  background: white;
...
.bank-icon {
  width: clamp(
    25.3px,
    calc(25.3px + (45 - 25.3) * ((100vw - 1024px) / (1920 - 1024))),
    45px
  );
  height: clamp(
    25.3px,
...
.product-name {
  ...
  font-size: clamp(
    14px,
    calc(14px + (22 - 14) * ((100vw - 1024px) / (1920 - 1024))),
    22px
  );
}
.bank-name {
  font-size: clamp(
    10px,
    calc(10px + (15 - 10) * ((100vw - 1024px) / (1920 - 1024))),
    15px
  );
  color: #666;
  margin-top: 0.2rem;
...
.rate {
  ...
  font-size: clamp(
    13px,
    calc(13px + (18 - 13) * ((100vw - 1024px) / (1920 - 1024))),
    18px
  );
  text-align: center;
}
